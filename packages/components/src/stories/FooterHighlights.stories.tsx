  ...
  parameters: {
    docs: {
      source: {
        language: 'tsx',
        code: `
<Box paddingX="xxl" paddingY="xl" style={{ background: 'var(--ds-color-background-container-inverted)' }}>
  <Stack gap="xl" style={{ maxWidth: '1200px', margin: '0 auto' }}>
    <Inline gap="xxl" align="start" wrap={false}>
      <Stack gap="lg" style={{ flex: 1 }}>
        <Stack gap="md">
          <Heading size="display" style={{ color: 'var(--ds-color-text-inverted-default)' }}>
            Discover the Power of{' '}
            <span style={{ color: 'var(--ds-color-text-accent-inverted)' }}>Beginner's Mind</span>
          </Heading>
          <Text style={{ color: 'var(--ds-color-text-inverted-default)' }}>
