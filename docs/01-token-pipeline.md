...
- Config: `packages/tokens/build.js` · Scripts: `npm run tokens:build`, `npm run tokens:usage`, `npm run tokens:contrast-check`, `npm run tokens:deprecations` — see the [npm scripts reference](07-npm-scripts-reference.md)
