...
- Case study: [The metadata contract](case-study-source/06-machine-readable-contract.md), [Rejected alternatives](case-study-source/04-rejected-alternatives.md), [Self-improving loops](case-study-source/07-self-improving-loops.md)
