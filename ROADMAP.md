...
| Phase | Status | Exit condition |
|---|---|---|
| 12 — Reference Site (Docsify → Starlight, ADR-022) | 🚧 in progress (Pages pending) | Site works locally + live on GitHub Pages, no broken links, mobile-clean |
...
## Phase 12 — Reference Site *(in progress — site built, Pages pending)*
...
- Migrated from Docsify to Starlight (`apps/docs/`, ADR-022): markdown stays in `docs/`, sidebar autogenerated, `case-study-source/` and `strategy/` no longer published, PR build gate `docs-build.yml`.
