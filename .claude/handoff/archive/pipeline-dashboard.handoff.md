...
- Uses the default `upskill` brand, same as the rest of the showcase. **Correction (2026-07-21):** the `horizon`-brand (`data-brand="horizon"`) demonstration described here was reassigned to the Pipeline Health Dashboard itself — see ROADMAP.md — not to the Homepage learner-facing content; this line originally said otherwise.
